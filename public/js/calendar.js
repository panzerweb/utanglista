                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex justify-content-between">                                   
                                    ...
                                    <span id="total-customer-day" class="text-success fw-semibold">${data}</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between">
                                    <strong class='d-flex align-items-center'>
                                    ...
                                    <span id="total-products-day" class="text-info fw-semibold"></span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between">
                                    <strong class='d-flex align-items-center'>
                                    ...
                                    <span id="total-products_sold-day" class="text-warning fw-semibold"></span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between">
                                    <strong class='d-flex align-items-center'>
                                    ...
                                    <span id="total-payemnt-day" class="text-danger fw-semibold"></span>
                                </li>
                            </ul>
                        </div>
                    </div>
